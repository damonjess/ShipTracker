...
class ShipRepositoryTest {
    ...
    @Test
    fun testFerryDatabasePassengerCapacity() = runTest {
        val ferry = ShipState(
            mmsi = 235009270L,
            latitude = 53.655,
            longitude = 0.050,
        ...
        ShipRepository.updateShip(ferry)

        val retrieved = ShipRepository.ships.value[235009270L]
        assertNotNull(retrieved)
        assertEquals(1360, retrieved?.passengerCapacity)
    }
}
