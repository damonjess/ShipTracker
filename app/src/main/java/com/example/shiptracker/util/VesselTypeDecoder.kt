...
object VesselTypeDecoder {
    ...
    fun getDetailedVesselType(aisTypeCode: Int, shipName: String = ""): String {
        ...
        return when {
            lowerName.contains("rnli") || lowerName.contains("lifeboat") ||
            lowerName.contains("rescue") || lowerName.contains("sar ") ||
            lowerName.contains("coastguard") -> "Search and Rescue Vessel"
