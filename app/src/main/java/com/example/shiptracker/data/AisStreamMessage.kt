...
data class ShipState(
    ...
    // 🚨 NEW: Nullable capacity field (null means we don't know it)
    val passengerCapacity: Int? = null,
    // 🚨 NEW: Ghost Ship Tracking variables
    val isGhost: Boolean = false,
    val lastSimulatedMillis: Long = System.currentTimeMillis(),
    // 🚨 NEW: Anomaly & Dark Fleet tracking fields
